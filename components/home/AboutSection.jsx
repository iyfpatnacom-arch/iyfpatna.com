...
export function AboutSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-black px-6 pb-10 pt-32 md:pb-14 md:pt-44" ref={ref}>
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        >
          Pioneering <span className="instrument-serif italic text-white/60">ideas</span> for
          <br className="hidden md:block" />
          minds that <span className="instrument-serif italic text-white/60">create, build, and inspire.</span>
        </motion.h2>
      </div>
    </section>
  );
