...
/** The temple's general WhatsApp group, shown on the schedule page. */
export async function getTempleWhatsappGroupUrl() {
  const settings = await getSettings();
  return (
    settings[SETTING_KEYS.templeWhatsappGroupUrl] || TEMPLE_WHATSAPP_GROUP_URL
  );
}
