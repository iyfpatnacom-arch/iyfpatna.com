...
/**
 * The same invite as a QR code, for the home page.
 *
 * A scannable code is the only form of the invite that works for a visitor
 * reading on a laptop, so it is a first-class asset rather than a generated
 * image: regenerate it from `WHATSAPP_GROUP_URL` and replace the file
 * whenever that link is rotated, or the code will quietly point at a dead
 * group while still scanning perfectly.
 */
export const WHATSAPP_GROUP_QR = "/whatsapp-group-qr.svg";
