 ...
 *
 * Off by default: the yatra portal is still being built, and this site is
 * already shared with people, so a link here would send them at a half-built
 * registration flow. Set NEXT_PUBLIC_YATRA_ENABLED=true to bring the nav item
 * and the home-page callout back — nothing else needs editing.
 *
 ...
 */
export const YATRA_ENABLED = ["1", "true", "yes", "on"].includes(
