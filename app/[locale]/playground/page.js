...
import { AppGrid } from "@/components/playground/AppGrid";
 ...
 * looks like on a phone and because the card grid, stacked one-up, buried the
 * last four tools below the fold. Wider screens keep the cards, where there is
 * room for a tagline beside the name. Both are rendered and one is hidden in
 * CSS rather than switched on a media query in JS: this page is prerendered at
 * build time and has no viewport to read.
 */
